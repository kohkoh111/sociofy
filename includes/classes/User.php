...
class User {
	...
	public function didReceiveRequest($user_from){
		...
		$check_request_query = mysqli_query($this->con, "SELECT * FROM friend_requests WHERE
			user_to='$user_to' AND user_from='$user_from'");
	...
	public function getNumbertOfFriendsReq(){
		$username = $this->user['username'];
